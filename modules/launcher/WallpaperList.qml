...
PathView {
    ...
    readonly property int numItems: {
        ...
        const barMargins = Math.max(Config.border.thickness, Config.bar.alignment === "top" || Config.bar.alignment === "bottom" ? panels.bar.implicitHeight : panels.bar.implicitWidth);
        let outerMargins = 0;
