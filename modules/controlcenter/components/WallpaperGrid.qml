...
Column {
    ...
    // Screen selector — only shown when more than one monitor is connected
    Row {
        anchors.horizontalCenter: parent.horizontalCenter
        spacing: Tokens.spacing.small
        visible: Wallpapers.screenNames.length > 1
    ...
    GridView {
        ...
        delegate: Item {
            ...
            readonly property bool isCurrent: modelData && modelData.path === Wallpapers.wallpaperForScreen(Wallpapers.selectedScreen)
