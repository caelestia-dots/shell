                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                Layout.fillWidth: true
                                text: {
                                    if (!modelData.enabled) return qsTr("Disabled");
                                ...
                                color: {
                                    if (!modelData.enabled) return Colours.palette.m3outline;
                                    if (VPN.status.state === "connected") return Colours.palette.m3primary;
                                    if (VPN.status.state === "error") return Colours.palette.m3error;
                                    if (VPN.status.state === "needs-auth") return Colours.palette.m3tertiary;
