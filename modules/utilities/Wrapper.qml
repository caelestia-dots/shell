...
Item {
    ...
    readonly property bool shouldBeActive: screenState.sidebar || ((screenState.utilities || screenState.utilitiesDragTarget) && Config.utilities.enabled && !(screenState.session && Config.session.enabled))
