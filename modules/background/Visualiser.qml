...
Item {
    ...
    readonly property bool shouldBeActive: Config.background.visualiser.enabled &&
        (!Config.background.visualiser.autoHide ||
         Hypr.monitorFor(screen).activeWorkspace.toplevels.values.every(t => t.lastIpcObject.floating))
    ...
    ServiceRef { id: cavaRef; service: Audio.cava }
