...
Scope {
    ...
    function handleKey(event: KeyEvent): void {
        ...
        // Se Howdy è attivo e l'utente preme un tasto (che non sia Enter), interrompiamo Howdy per dare priorità alla password
    ...
    // Fprint dummy completo di tutte le proprietà attese dalla UI
    QtObject {
        id: dummyFprint
        property bool available: false
