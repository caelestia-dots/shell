    ...
    function serializeDashboard(): var {
        return {
            ...
            performance: {
                ...
                normalTextSize: dashboard.performance.normalTextSize,
                largeIconSize: dashboard.performance.largeIconSize,
                tempBarHeight: dashboard.performance.tempBarHeight,
                ...
                heroCardRightMargin: dashboard.performance.heroCardRightMargin,
                heroCardRightValueMargin: dashboard.performance.heroCardRightValueMargin,
